...
def test_24h_anchor_budget_has_exact_epoch_environment_and_exposure_semantics() -> None:
    expected = {
        "Cus50": (100, 200, 20_000, 1_000_000),
        "Cus100": (200, 50, 10_000, 1_000_000),
        "Cus500": (500, 4, 2_000, 1_000_000),
        "Cus1000": (1_000, 1, 1_000, 1_000_000),
    }
    formal = [
        row
        for queue in build().values()
    ...
    for row in formal:
        ...
        assert row["runtime_budget_id"] == "drl_rq_runtime_budget_v2_cus1000_24h_anchor"
        ...
        assert row["planning_wall_time_hours"] == (
            24 if row["scale"] == "Cus1000" else None
        )
