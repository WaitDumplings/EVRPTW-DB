...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train Edge-DIRECT-H on Stage-2.")
    ...
    for epoch in range(args.epochs):
        ...
        for step in range(args.steps_per_epoch):
            ...
            actor_envs = make_envs(
                instances, n_traj=args.samples_per_instance, info_level="light"
            )
            actor = rollout(
                policy,
                actor_envs,
