...
RUNTIME_BUDGET_ID="drl_rq_runtime_budget_v10_min5000_max10000_tailval50"
...
valid_budget = d.get("runtime_budget_id") == "drl_rq_runtime_budget_v10_min5000_max10000_tailval50"
