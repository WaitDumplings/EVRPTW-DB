...
The four commands `full.sh`, `resume.sh`, `status.sh`, `logs.sh` forward to [the current RQ bundle](../rq_v1/2080ti_4_1/README.md). The remaining pilot/start/run scripts and jobs.jsonl are retained historical protocol entry points. See [profile notes](../../configs/2080ti/README.md).
