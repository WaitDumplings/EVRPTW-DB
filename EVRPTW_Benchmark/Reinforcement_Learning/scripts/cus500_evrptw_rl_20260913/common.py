"""Portable paths and atomic records for the independent Cus500 EVRPTW-RL experiment."""
...
MODELS = ("evrptw_rl",)
OUTPUT = REPO / "EVRPTW_Benchmark/results/cus500_evrptw_rl_20260913"
...
def load_config(path=None, *, model="evrptw_rl", gpus="0,1", batch=None, accumulation=None, cache_size=None):
