...
cus500_output="${CUS500_EVRPTW_GPU12_OUTPUT_ROOT:-${repo_root}/EVRPTW_Benchmark/results/cus500_evrptw_rl_mean_gpu12_20260914}"
...
exec "${cus500_python}" "${script_dir}/launch.py" \
    ...
    --config "${script_dir}/config_gpu12_mean.json" \
